...
class _ProductScreenState extends State<ProductScreen> {
  static List<ProductItems> mainProductList = [
    ...
    ProductItems(productName: 'Detergent -\nSurf Oxybubbles Bar', image: 'assets/products/detergent/surf.png', price: 21.75),
    ...
    ProductItems(productName: 'Mineralized Water -\nHidden Spring', image: 'assets/products/mineralized/Hidden.png', price: 12.1),
    ProductItems(productName: 'Mineralized Water -\nSummit ', image: 'assets/products/mineralized/summit.png', price: 14.5),
    ProductItems(productName: 'Mineralized Water -\nViva', image: 'assets/products/mineralized/Viva.png', price: 13),
